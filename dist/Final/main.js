...
var HmaddschoolComponent = /** @class */ (function () {
    ...
    HmaddschoolComponent.prototype.addschool = function (form) {
        ...
        this.schoolService.addSchool("", this.studentID, "进行中", form.value.University, form.value.Uschool, form.value.major, form.value.ddl1, form.value.ddl2, form.value.ddl3, form.value.interview, form.value.videoessay, form.value.link, form.value.applyAccount, form.value.applyPassword, form.value.recommNumber, "");
...
var HmmanageComponent = /** @class */ (function () {
    function HmmanageComponent(route, router, http, hmService) {
        ...
        this.student = []; //the specific order selected by this hotel i
        this.hotels = [];
        this.route.queryParams.subscribe(function (params) {
            _this.managerID = params["managerID"];
        });
...
module.exports = "/* Set height of the grid so .sidenav can be 100% (adjust if needed) */\n.row.content {\n  height: 4000px; }\n/* Set gray background color and 100% height */\n.sidenav {\n  background-color: #f1f1f1;\n  height: 100%; }\n/* On small screens, set height to 'auto' for sidenav and grid */\n@media screen and (max-width: 767px) {\n  .sidenav {\n    height: auto;\n    padding: 15px; }\n  .row.content {\n    height: auto; } }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "/* Set height of the grid so .sidenav can be 100% (adjust if needed) */\n.row.content {\n  height: 1500px; }\n/* Set gray background color and 100% height */\n.sidenav {\n  background-color: #f1f1f1;\n  height: 100%; }\n/* On small screens, set height to 'auto' for sidenav and grid */\n@media screen and (max-width: 767px) {\n  .sidenav {\n    height: auto;\n    padding: 15px; }\n  .row.content {\n    height: auto; } }\n\n/*# sourceMappingURL=data:application/json;base64, */"
