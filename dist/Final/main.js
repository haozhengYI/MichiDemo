...
var HmaddschoolComponent = /** @class */ (function () {
    ...
    HmaddschoolComponent.prototype.addschool = function (form) {
        ...
        this.schoolService.addSchool("", this.studentID, "进行中", form.value.University, form.value.Uschool, form.value.major, form.value.ddl1, form.value.ddl2, form.value.ddl3, form.value.interview, form.value.videoessay, form.value.link, "", "", form.value.recommNumber, form.value.applyAccount, form.value.level);
        //这里applyAccount其实是 备注信息
        ...
        //If all field are success, check if the account already exist
            ...
            if (indexc == this.user.length) {
                ...
                if (temp3.checked == true) {
                    ...
                    console.log(temp0);
                    this.stService.addStudent("", temp0, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "2022");
                    //共65个属性
                }
...
var HmstudentComponent = /** @class */ (function () {
    ...
    //更新学生年级信息
    HmstudentComponent.prototype.updatePersonal = function () {
        var Student = {
            userAccount: this.student.userAccount,
...
module.exports = "body {\n  font: 400 15px Lato, sans-serif;\n  line-height: 1.8;\n  color: #818181; }\n\nh2 {\n  font-size: 24px;\n  text-transform: uppercase;\n  color: #303030;\n  font-weight: 600;\n  margin-bottom: 30px; }\n\nh4 {\n  font-size: 19px;\n  line-height: 1.375em;\n  color: #303030;\n  font-weight: 400;\n  margin-bottom: 30px; }\n\n.jumbotron {\n  background-color: #02351F;\n  color: #fff;\n  padding: 100px 25px;\n  font-family: Montserrat, sans-serif; }\n\n.container-fluid {\n  padding: 60px 50px;\n  background-color: #02351F !important; }\n\n.bg-grey {\n  background-color: #f6f6f6; }\n\n.logo-small {\n  color: #02351F;\n  font-size: 50px; }\n\n.logo {\n  color: #02351F;\n  font-size: 200px; }\n\n.thumbnail {\n  padding: 0 0 15px 0;\n  border: 1px;\n  border-color: lightgray;\n  border-radius: 0; }\n\n.thumbnail img {\n  width: 100%;\n  height: 100%;\n  margin-bottom: 10px; }\n\n.carousel-control.right, .carousel-control.left {\n  background-image: none;\n  color: #02351F; }\n\n.carousel-indicators li {\n  border-color: white; }\n\n.carousel-indicators li.active {\n  background-color: white; }\n\n.item h4 {\n  font-size: 19px;\n  line-height: 1.375em;\n  font-weight: 400;\n  font-style: italic;\n  margin: 70px 0; }\n\n.item span {\n  font-style: normal; }\n\n.panel {\n  border: 1px solid #02351F;\n  border-radius: 0 !important;\n  transition: box-shadow 0.5s; }\n\n.panel:hover {\n  box-shadow: 5px 0px 40px rgba(0, 0, 0, 0.2); }\n\n.panel-footer .btn:hover {\n  border: 1px solid #02351F;\n  background-color: #fff !important;\n  color: #02351F; }\n\n.panel-heading {\n  color: #fff !important;\n  background-color: #02351F !important;\n  padding: 25px;\n  border-bottom: 1px solid transparent;\n  border-top-left-radius: 0px;\n  border-top-right-radius: 0px;\n  border-bottom-left-radius: 0px;\n  border-bottom-right-radius: 0px; }\n\n.panel-footer {\n  background-color: #02351F !important; }\n\n.panel-footer h3 {\n  font-size: 32px; }\n\n.panel-footer h4 {\n  color: white;\n  font-size: 14px; }\n\n.panel-footer .btn {\n  margin: 15px 0;\n  background-color: #02351F;\n  color: #fff; }\n\n.navbar {\n  margin-bottom: 0;\n  background-color: #02351F;\n  z-index: 9999;\n  border: 0;\n  font-size: 12px !important;\n  line-height: 1.42857143 !important;\n  letter-spacing: 4px;\n  border-radius: 0;\n  font-family: Montserrat, sans-serif; }\n\n.navbar li a, .navbar .navbar-brand {\n  color: #fff !important; }\n\n.navbar-nav li a:hover, .navbar-nav li.active a {\n  color: #02351F !important;\n  background-color: #fff !important; }\n\n.navbar-default .navbar-toggle {\n  border-color: transparent;\n  color: #fff !important; }\n\nfooter .glyphicon {\n  font-size: 20px;\n  margin-bottom: 20px;\n  color: #02351F; }\n\n.slideanim {\n  visibility: hidden; }\n\n.slide {\n  animation-name: slide;\n  -webkit-animation-name: slide;\n  animation-duration: 1s;\n  -webkit-animation-duration: 1s;\n  visibility: visible; }\n\n.caption {\n  text-align: center; }\n\n.section-title h2 {\n  font-size: 28px;\n  font-weight: 400;\n  margin-bottom: 20px;\n  padding-bottom: 20px;\n  position: relative;\n  text-align: center; }\n\n.section-title h4 {\n  text-align: center; }\n\n.section-title h2::before {\n  content: '';\n  position: absolute;\n  display: block;\n  width: 120px;\n  height: 1px;\n  background: #ddd;\n  bottom: 1px;\n  left: calc(50% - 60px); }\n\n.section-title h2::after {\n  content: '';\n  position: absolute;\n  display: block;\n  width: 40px;\n  height: 3px;\n  background: #02351F;\n  bottom: 0;\n  left: calc(50% - 20px); }\n\n@keyframes slide {\n  0% {\n    opacity: 0;\n    -webkit-transform: translateY(70%);\n            transform: translateY(70%); }\n  100% {\n    opacity: 1;\n    -webkit-transform: translateY(0%);\n            transform: translateY(0%); } }\n\n@-webkit-keyframes slide {\n  0% {\n    opacity: 0;\n    -webkit-transform: translateY(70%); }\n  100% {\n    opacity: 1;\n    -webkit-transform: translateY(0%); } }\n\n@media screen and (max-width: 768px) {\n  .col-sm-4 {\n    text-align: center;\n    margin: 25px 0; }\n  .btn-lg {\n    width: 100%;\n    margin-bottom: 35px; } }\n\n@media screen and (max-width: 480px) {\n  .logo {\n    font-size: 150px; } }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var StudentinfoComponent = /** @class */ (function () {
    ...
    StudentinfoComponent.prototype.updatePersonal = function () {
        ...
        alert("更新个人信息成功!!" + document.getElementById("firstName").value);
        window.location.reload();
    };
