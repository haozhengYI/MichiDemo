...
export class StudentinfoComponent implements OnInit {
  ...
  addEducation(form: NgForm){//form内的信息使用过html中的name来获取的
    ...
    this.educationService.addEducation("", this.studentID,form.value.type,form.value.educationName, form.value.educationLocation, form.value.educationStart,
      form.value.educationEnd, form.value.major, form.value.Degree, form.value.GPA, form.value.MajorGPA, form.value.SecondDegree,
       form.value.SecondGPA, form.value.other );
      alert("添加教育背景成功!!");
      window.location.reload();  
  }
  ...
  addExperience(form: NgForm){//form内的信息使用过html中的name来获取的
    ...
    //console.log("School名" + form.value.type );
    this.experienceService.addExperience("", this.studentID,form.value.experiencetype,form.value.institution, form.value.institutionLocation, form.value.experienceStart,
      form.value.experienceEnd, form.value.experienceposition, form.value.responsibilities, form.value.project, form.value.achievement );
      alert("添加工作背景成功!!");
      window.location.reload();  
  }
  ...
  addPublication(form: NgForm){//form内的信息使用过html中的name来获取的
    ...
    //console.log("School名" + form.value.type );
    this.publicationService.addPublication("", this.studentID,form.value.PublicationTitle,form.value.PublicationJournal, form.value.PublicationDate, form.value.PublicationLink,
      form.value.PublicationAuthors, form.value.PublicationAbstract, form.value.PublicationLevel,);
      alert("添加论文成功!!");
      window.location.reload();  
  }
  ...
  addActivity(form: NgForm){//form内的信息使用过html中的name来获取的
    ...
    //console.log("School名" + form.value.type );
    this.activityService.addActivity("", this.studentID,form.value.activityOrganization,form.value.activityStart, form.value.activityEnd, form.value.activityPosition,
      form.value.activityDescription, );
      alert("添加课外活动成功!!");
      window.location.reload();  
  }
  ...
  addHonor(form: NgForm){//form内的信息使用过html中的name来获取的
    ...
    console.log("奖项日期" + form.value.prize );
    // this.honorService.addHonor("", this.studentID,form.value.honorDate,form.value.prize, 
    // form.value.percentage, form.value.grantor);
       alert("添加奖励成功!!");
      window.location.reload();  
  }
