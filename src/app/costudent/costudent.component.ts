...
@Component({
  selector: 'app-costudent',
  templateUrl: './costudent.component.html',
  styleUrls: ['./costudent.component.scss']
})
export class CostudentComponent implements OnInit {
  ...
  hmschooldetail(s) {
    const fullName = this.studentName
      || (this.student ? (this.student.firstName + " " + this.student.lastName) : "");
    const navigationExtras: NavigationExtras = {
      queryParams: {
