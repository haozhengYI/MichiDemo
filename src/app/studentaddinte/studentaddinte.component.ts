...
export class StudentaddinteComponent implements OnInit {
  ...
  constructor(
    ...
    addinterview(form: NgForm){//form内的信息使用过html中的name来获取的
      ...
      this.interviewService.addInterview("", form.value.interviewUniv,form.value.interviewSchool,form.value.interviewProgram,form.value.interviewTitle, form.value.interviewCato, form.value.interviewTime, "XX " + this.student.lastName, form.value.interviewDuration, form.value.interviewOther,
     );
